					...
					<div className="row">
						<div className="col-lg-8 col-md-10 mx-auto">
							<div className="post-preview">
								<a href="/log">
									<div key={log.id}>
										<h2 className="post-title" style={postTitleStyle}> <LogItem log={log} /></h2>
										<h3 className="post-subtitle" style={postSubtitleStyle}>Subtitle</h3>
									</div>
								</a>
								<p className="post-meta">Posted by <a href="/"> Andrew Moss </a> on {log.date}</p>
							</div>
							<hr />
						</div>
					</div>
